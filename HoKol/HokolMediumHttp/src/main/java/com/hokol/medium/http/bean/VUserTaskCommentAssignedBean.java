...
{
	private List<VUserTaskCommentAssignedOneBean> list;

	public List<VUserTaskCommentAssignedOneBean> getList()
	{
		return list;
	}

	public void setList(List<VUserTaskCommentAssignedOneBean> list)
	{
		this.list = list;
	}

	public static class VUserTaskCommentAssignedOneBean
	{
		/* 用户ID */
