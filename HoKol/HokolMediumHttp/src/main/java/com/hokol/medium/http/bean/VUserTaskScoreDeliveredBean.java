...
public class VUserTaskScoreDeliveredBean
{
	private List<VUserTaskScoreDeliveredOneBean> list;

	public List<VUserTaskScoreDeliveredOneBean> getList()
	{
		return list;
	}

	public void setList(List<VUserTaskScoreDeliveredOneBean> list)
	{
		this.list = list;
	}

	public static class VUserTaskScoreDeliveredOneBean
	{
		/* 任务ID */
