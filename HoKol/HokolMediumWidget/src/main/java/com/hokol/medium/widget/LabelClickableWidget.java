 ...
 * @version 1.0.0
 */
public class LabelClickableWidget
{
	...
	public LabelClickableWidget(Context context)
	{
		...
		{
			containerView = LayoutInflater.from(context).inflate(R.layout.widget_label_clickable_layout, null);
	...
	{
		return R.layout.widget_item_label_clickable_layout;
	}
